# Script de Despliegue Fasticket en AWS ECS (Configuracion Simplificada)
param(
    [switch]$Clean = $false
)
...
function Start-Deployment {
    ...
    Write-Host "DESPLIEGUE FASTICKET EN AWS ECS" -ForegroundColor Cyan
    ...
    Show-DeploymentInfo -TAG_VERSION $TAG_VERSION -ECR_URL $ECR_URL -PublicIP $PublicIP
